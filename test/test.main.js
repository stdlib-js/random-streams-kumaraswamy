...
tape( 'the function throws an error if first shape parameter `a` is not a positive number primitive', function test( t ) {
	var values;
	var i;
...
tape( 'the function throws an error if second shape parameter `b` is not a positive number primitive', function test( t ) {
	var values;
	var i;
...
tape( 'the constructor returns a stream for generating pseudorandom numbers from a Kumaraswamy\'s double bounded distribution', function test( t ) {
	var iStream;
	var result;
	var rand;
	var opts;
...
tape( 'the constructor returns a stream for generating pseudorandom numbers from a Kumaraswamy\'s double bounded distribution (object mode)', function test( t ) {
	var iStream;
	var count;
	var rand;
	var opts;
